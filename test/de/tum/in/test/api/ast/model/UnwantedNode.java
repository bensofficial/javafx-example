...
public class UnwantedNode {
    ...
    private final List<de.tum.in.test.api.ast.model.NodePosition> unwantedNodePositions;
    ...
    public UnwantedNode(JavaFile javaFile, String unwantedNodeName, Class<? extends Node> nodeDefinedAsUnwanted) {
        ...
        this.unwantedNodePositions = javaFile.getJavaFileAST().findAll(nodeDefinedAsUnwanted).stream()
                .map(de.tum.in.test.api.ast.model.NodePosition::getPositionOf).collect(Collectors.toList());
        this.unwantedNodePositions.sort(de.tum.in.test.api.ast.model.NodePosition::compareTo);
    }
