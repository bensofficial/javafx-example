...
public class DynamicMethod<T> implements Checkable {
    ...
    private final de.tum.in.test.api.dynamic.DynamicClass<?>[] parameters;
    private final de.tum.in.test.api.dynamic.DynamicClass<T> returnType;
    private Method m;

    public DynamicMethod(de.tum.in.test.api.dynamic.DynamicClass<?> dClass, Class<T> dynamicableReturn, String mName,
                         Object... dynamicableParams) {
        this(dClass, de.tum.in.test.api.dynamic.DynamicClass.toDynamic(dynamicableReturn), mName, dynamicableParams);
    }

    public DynamicMethod(de.tum.in.test.api.dynamic.DynamicClass<?> dClass, de.tum.in.test.api.dynamic.DynamicClass<T> dynamicableReturn, String mName,
                         Object... dynamicableParams) {
        ...
        this.parameters = de.tum.in.test.api.dynamic.DynamicClass.toDynamic(Objects.requireNonNull(dynamicableParams));
    }

    public static String signatureOf(Method method) {
        return method.getName() + descParams(de.tum.in.test.api.dynamic.DynamicClass.toDynamic(method.getParameterTypes()));
    }
    ...
    public static String descParams(de.tum.in.test.api.dynamic.DynamicClass<?>... params) {
    ...
    public Method toMethod() {
        if (m == null) {
            try {
                m = owner.toClass().getDeclaredMethod(name, de.tum.in.test.api.dynamic.DynamicClass.resolveAll(parameters));
                m.trySetAccessible();
    ...
    public T invokeOn(Object o, Object... params) {
        try {
            ...
            return de.tum.in.test.api.dynamic.DynamicClass.rethrowUnchecked(e.getCause());
