...
enum ExceptionInInitializerErrorSanitizer implements de.tum.in.test.api.internal.sanitization.SpecificThrowableSanitizer {
    INSTANCE;
    ...
    public Throwable sanitize(Throwable t, MessageTransformer messageTransformer) {
        ...
        de.tum.in.test.api.internal.sanitization.SanitizationUtils.copyThrowableInfoSafe(info, newEiie);
        return newEiie;
    }
}
