...
final class ThrowableUtils {
    ...
    private static final Comparator<Entry<String, Method>> ORDER_PROPERTIES_BY_RELEVANCE = Entry
    ...
    static de.tum.in.test.api.internal.sanitization.ThrowableCreator getThrowableCreatorFor(Class<? extends Throwable> type) {
    ...
    static de.tum.in.test.api.internal.sanitization.ThrowableCreator getThrowableCreatorFor(Class<? extends Throwable> type,
        ...
        return info -> {
            ...
            try {
                ...
                throw new de.tum.in.test.api.internal.sanitization.SanitizationException(type, e.getCause());
            } catch (Exception e) {
                throw new de.tum.in.test.api.internal.sanitization.SanitizationException(type, e);
            }
        };
    }
