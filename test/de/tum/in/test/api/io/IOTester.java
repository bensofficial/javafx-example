...
public final class IOTester {
    ...
    private final de.tum.in.test.api.io.InputTester inTester;
    ...
    private IOTester(boolean mirrorOutput, long maxChars) {
        ...
        inTester = new de.tum.in.test.api.io.InputTester();
    ...
    public de.tum.in.test.api.io.InputTester getInTester() {
        return inTester;
    }
     ...
     *
     * @return the {@link de.tum.in.test.api.io.InputTester} for {@link System#in}
     */
