...
public class ClassNameScanner {
    ...
    private de.tum.in.test.api.structural.testutils.ScanResult computeScanResult() {
        ...
        return createScanResult(de.tum.in.test.api.structural.testutils.ScanResultType.NOTFOUND, expectedClassName, null);
    }

    private de.tum.in.test.api.structural.testutils.ScanResult createScanResult(String foundObservedClassName, String foundObservedPackageName,
                                                                                boolean classPresentMultiple, boolean classCorrectlyPlaced, de.tum.in.test.api.structural.testutils.ScanResultType multipleTimes,
                                                                                de.tum.in.test.api.structural.testutils.ScanResultType correctPlace, de.tum.in.test.api.structural.testutils.ScanResultType misplaced) {
        de.tum.in.test.api.structural.testutils.ScanResultType scanResultType;
    ...
    private de.tum.in.test.api.structural.testutils.ScanResultType getScanResultTypeClassFound(List<String> observedPackageNames) {
    ...
    private de.tum.in.test.api.structural.testutils.ScanResult createScanResult(de.tum.in.test.api.structural.testutils.ScanResultType scanResultType, String foundClassName, String foundPackageName) {
